...
import { Save, Plus, ArrowRight, Check, Trash, Loader } from 'lucide-vue-next'
import languages from '@cospired/i18n-iso-languages'
import { ref, watch, watchEffect } from 'vue';
import enLocale from '@cospired/i18n-iso-languages/langs/en.json';
import { api } from '../../convex/_generated/api';
import { useConvexQuery, useConvexMutation, ConvexQuery, ConvexPaginatedQuery } from "@convex-vue/core";
